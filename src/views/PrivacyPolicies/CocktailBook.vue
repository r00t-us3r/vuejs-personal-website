<template>
    <main id="privacy-policy" style="text-align: left">
      ...
      <ul>
        ...
        <li><strong>Application</strong> refers to Cocktail Book, the software program provided by the Company.</li>
      </ul>
      <ul>
        <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Cocktail Book.</li>
      </ul>
      <ul>
        <li><p><strong>Country</strong> refers to:  United Kingdom</p>
        </li>
      ...
      <ul>
        <li>By email: apps@deancole.info</li>
      </ul>
